...
const CORE_ASSETS = [
  ...
  "./setup.js?v=32",
  "./build-sets.js?v=32",
  "./paste-session.js?v=32",
  "./review.js?v=32",
  "./practice.js?v=32",
  "./session-rating.js?v=32",
  "./summary.js?v=32",
  "./session-detail.js?v=32",
  "./session-edit.js?v=32",
  "./saved-sessions.js?v=32",
  "./saved-session-detail.js?v=32",
  "./stats.js?v=32",
  "./settings.js?v=32",
  "./swing-thoughts.js?v=32",
  "./swing-thought-form.js?v=32",
  "./swing-thought-detail.js?v=32",
  "./manifest.json",
  "./icons/icon-192.png",
  "./icons/icon-512.png",
